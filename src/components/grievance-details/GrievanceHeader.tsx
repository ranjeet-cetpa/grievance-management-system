...
export const GrievanceHeader = ({ title, status, getStatusText }: GrievanceHeaderProps) => {
    ...
    <div className="border-b">
      <div className="container  p-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <Badge variant="outline" className={`px-4 py-1.5 text-sm font-medium ${getStatusColor(status)}`}>
